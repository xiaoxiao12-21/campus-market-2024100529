<template>
  <section class="page">
    ...
    <form class="publish-form" @submit.prevent="handleSubmit">
      ...
      <div class="actions">
        <button type="button" class="secondary" @click="handleReset">重置</button>
...
async function handleSubmit() {
  ...
  try {
    ...
    if (publishType.value === 'errand') {
      ...
      console.log('跑腿委托发布成功')
      router.push('/errand')
    }
  } catch (error) {
    console.error(error)
    console.warn('发布失败，请检查 Mock 服务是否正常运行')
  } finally {
